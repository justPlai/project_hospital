	...
	public class DoctorService { 
	   ...
	   public Response getUsers() throws JsonGenerationException, 
		...
		public Response createDoctor(Doctor doc) throws IOException {
	   		...
	   		HospitalDAO hostDAO = new HospitalDAO(); 
	   		Hospital h =  hostDAO.findByID(doc.getHospital().getHospitalId()) ;
		...
		@Path("/doctors")
		@Consumes(MediaType.APPLICATION_JSON)
		public Response updateDoctor(Doctor Doctor) throws  JsonGenerationException, 
		JsonMappingException, IOException 
		 {	
			...
			@Path("/doctors/{id}")
			@Consumes(MediaType.APPLICATION_JSON)
			public Response deleteDoctor(@PathParam("id") int id) throws  JsonGenerationException, 
			JsonMappingException, IOException 
		   	{	
